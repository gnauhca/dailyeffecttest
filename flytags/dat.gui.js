...
(function (global, factory) {
    ...
    function NumberController(object, property, params) {
      ...
      if (Common.isUndefined(_this.__step)) {
        if (_this.initialValue === 0) {
          ...
          _this.__impliedStep = 10 ** Math.floor(Math.log(Math.abs(_this.initialValue)) / Math.LN10) / 10;
        }
      } else {
  ...
  const NumberControllerSlider = (function (_NumberController) {
    ...
    function NumberControllerSlider(object, property, min, max, step) {
      ...
      const _this2 = possibleConstructorReturn(this, (NumberControllerSlider.__proto__ || Object.getPrototypeOf(NumberControllerSlider)).call(this, object, property, { min, max, step }));
      const _this = _this2;
  ...
  const requestAnimationFrame$1 = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || requestAnimationFrame;
