...
class IosSelector {
  constructor(options) {
    ...
    this.options = Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["assignIn"])(defaults, options);
    this.options.count =  this.options.count - this.options.count % 4;
    Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["assign"])(this, this.options);
